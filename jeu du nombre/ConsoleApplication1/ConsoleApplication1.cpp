			...
			if (s == 1)
			{
				...
				if (u == 1)
				{
					...
					while (!(nbale == nbuti) && !(i == 7))
					{
						...
						if (nbale > nbuti)
						{
							printf("\nC'est plus ! (Chance(s) utilisee(s) : %d/6)\n", i);
						}

						else if (nbale < nbuti)
						{
							printf("\nC'est moins ! (Chance(s) utilisee(s) : %d/6)\n", i);
						}
				...
				else if (u == 2)
				{
					...
					printf("\nVous avez decide de jouer.\n");
					printf("\nEntrez un nombre entre 0 et 1000 pour essayer de trouver le nombre mystere. (Chance(s) utilisee(s) : %d/13)\n", i);
					i++;
					...
					while (!(nbale == nbuti) && !(i == 11))
					{
						...
						if (nbale > nbuti)
						{
							printf("\nC'est plus ! (Chance(s) utilisee(s) : %d/10)\n", i);
						}

						else if (nbale < nbuti)
						{
							printf("\nC'est moins ! (Chance(s) utilisee(s) : %d/10)\n", i);
						}
